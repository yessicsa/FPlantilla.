...
class ClienteUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'email'=>'string|required|unique:clientes,email,'.$this->route('cliente')->id.'|max:255|email:ric,dns',
            'dni'=>'string|required|unique:clientes,dni,'.$this->route('cliente')->id.'|max:8',
            'ruc'=>'string|required|unique:clientes,ruc,'.$this->route('cliente')->id.'|max:10',
            'direccion'=>'string|required|max:255',
            'telefono'=>'string|required|unique:clientes,telefono,'.$this->route('cliente')->id.'|max:10',
        ];
    }
