...
<head>
    ...
    <title>SALES ABARROTES - Alta de PRODUCTOS</title>
    ...
    <body>    
        ...
        <div class="col-sm-12" style="margin-top:100px; padding-left:60px;">
            <div class="col-sm-4" style="padding-top: 4%; position: fixed;">
                ...
                @endif
                <h2 align="center"><span>Registro de Productos</span></h2>
                <br>
                <hr>
                <br>
                <form action="" method="post" class="was-validated" style="margin-right: 5%; margin-left: 5%; text-align: center;" autocomplete="off">
                    @csrf
                    <div class="form-group" style="text-align: left;">
                        <label for="uname"><b>Codigo:</b></label>
                        <input maxlength="15" type="text" class="form-control" placeholder="Número de empleado del cliente" name="noEmpleado" onkeypress="return soloNumeros(event)" required>                    
            ...
            <div class="col-sm-8" style="float: right; padding-left: 3%; padding-right: 3%;">
                <br>
                <h3 align="center"><span>Productos registrados</span></h3>
                <a href=""><span class="nav-text">Excel</span></a>
                <br><hr>
